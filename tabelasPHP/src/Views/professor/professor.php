...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Professores</h1>
        <a href="/empresa/inserir" class="btn btn-primary">Novo Professor</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $c['telefone'] ?></td>
                            <td>
                                <a href="/empresa/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/empresa/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
