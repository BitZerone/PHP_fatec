...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Animais</h1>
        <a href="/animal/inserir" class="btn btn-primary">Novo Animal</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $c['cor'] ?></td>
                            <td>
                                <a href="/animal/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/animal/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
